...
compiler tag it is locked to: `teko` v0.25.3 carries `MC_VERSION` 1.0.1 and is built by
...
2. its dependency, `teko` (`[deps] teko = "0.25.3"`, the pinned version above), registered and
