...
compiler tag it is locked to: `teko` v0.19.0 carries `MC_VERSION` 1.0.0 and is built by
...
2. its dependency, `teko` (`[deps] teko = "0.19.0"`, the pinned version above), registered and
