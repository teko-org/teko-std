...
compiler tag it is locked to: `teko` v0.22.0 carries `MC_VERSION` 1.0.1 and is built by
...
2. its dependency, `teko` (`[deps] teko = "0.22.0"`, the pinned version above), registered and
